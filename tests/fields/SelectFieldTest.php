...
class SelectFieldTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $form = new Form();
        $form->a = new SelectField([
            "choices" => [["a", "hello"], ["btest", "bye"]],
            "default" => "a"
        ]);
        $form->b = new SelectField([
    ...
    public function testDefaults()
    {
        ...
        $this->assertEquals('<select id="a" name="a"><option selected value="a">hello</option><option value="btest">bye</option></select>',
            $this->form->a->__toString());
        $this->assertEquals($this->form->a->__toString(), $this->form->a->__invoke());
        $this->assertEquals($this->form->a->__toString(), "{$this->form->a}");
        $this->assertEquals('<select id="b" name="b"><option value="1">Item 1</option><option value="2">Item 2</option></select>',
            $this->form->b->__toString());
    ...
    public function testWithData()
    {
        ...
        $this->assertEquals('<select id="a" name="a"><option value="a">hello</option><option selected value="btest">bye</option></select>',
            $this->form->a->__toString());
    }
    ...
    public function testIterableOptions()
    {
        ...
        $this->assertEquals(['<option selected value="a">hello</option>', '<option value="btest">bye</option>'],
            $text_options);
